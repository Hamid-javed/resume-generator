  ...
  return (
    <div className="min-h-screen gradient-hero flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="mb-8">
          <button onClick={() => navigate('/')} className="flex items-center gap-2 text-primary-foreground/60 hover:text-primary-foreground transition-colors mb-8">
          ...
          <p className="text-primary-foreground/60 mt-1">
            {isLogin ? 'Sign in to manage your resumes' : 'Start building professional resumes'}
          </p>
        </div>
        ...
        <div className="bg-card rounded-xl p-6 shadow-xl border border-border">
          ...
          <form onSubmit={handleEmailAuth} className="space-y-4">
            ...
            <Button type="submit" className="w-full gradient-electric text-primary-foreground" disabled={loading}>
